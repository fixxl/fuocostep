	...
	\chapter{Aufbau}
		...
		\section{Panel}
			...
			\subsection*{Vorgehensweise}
				...
				\begin{center}
					\includegraphics[width=.8\textwidth]{panel3d}
				...
				\begin{figure}
					\centering\includegraphics[width=.5\textwidth]{displayloetung}
		...
		\section{Basis}
			...
			\subsection*{Vorgehensweise}
				...
				\begin{figure}[H]
					\centering\includegraphics[width=.7\textwidth]{base3d}
	...
	\chapter{Programmierung}
		...
		\section{Oberfläche}
			...
			\subsection{Zusatzfenster Absolutzeiten}
				...
				\begin{figure}[tb]
					\begin{center}
						\includegraphics[width=.8\textwidth]{beispielzeitvorgabe}{\\}\includegraphics[width=.8\textwidth]{beispielabsolut}
					\end{center}
