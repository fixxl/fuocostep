 ...
 * leds.h
 *
 * Definitionen und Funktionen f�r die Status-LEDs
 */

#ifndef LED_H_
#define LED_H_

#define LED_YELLOW_P   C
#define LED_YELLOW_NUM 1
#define LED_RED_P      D
#define LED_RED_NUM    4
#define LED_GREEN_P    C
#define LED_GREEN_NUM  0
#define LED_ORANGE_P   C
#define LED_ORANGE_NUM 2
